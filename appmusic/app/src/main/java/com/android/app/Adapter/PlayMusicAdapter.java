...
public class PlayMusicAdapter extends RecyclerView.Adapter<PlayMusicAdapter.ViewHolder>{
    ...
    public PlayMusicAdapter(Context context, ArrayList<Song> song_array) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view = inflater.inflate(R.layout.layout_play_all, parent, false);
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(@NonNull View itemView) {
            super(itemView);
            tvTitle = itemView.findViewById(R.id.tvSongTitlePAll);
            tvArtist = itemView.findViewById(R.id.tvSongArtistPAll);
            tvIndex = itemView.findViewById(R.id.tvSongIndexPAll);
            ivLove = itemView.findViewById(R.id.ivPlayAllLove);
